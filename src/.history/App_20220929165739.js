  ...
  return (
    <>
     <BrowserRouter >
          ...
          <Routes>
            <Route path='/' element={<News setprogress={setprogress}  apikey={apikey} mode={mode} key="general" pagesize={size} category="general" />} />
            <Route path='/about' element={<News setprogress={setprogress} apikey={apikey} mode={mode} key="general" pagesize={size} category="general" />} />
            <Route path='/sports' element={<News setprogress={setprogress} togglemode = {togglemode} apikey={apikey} key="sports" mode={mode} pagesize={size} category="sports" />} />
