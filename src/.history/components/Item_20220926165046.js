import React, { Compopropsnent } from 'react'
...
export default function Item(props) {
    ...
    return (
        <>
            <div>
                <div className="card" style={{ backgroundColor: mode === "dark" ? "black" : "white", color: mode === "dark" ? "white" : "black", borderColor: mode === "dark" ? "grey" : "white" }} >
